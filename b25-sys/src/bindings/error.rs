...
impl Display for AribB25DecoderError {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        ...
        match *self {
            ...
            E::ARIB_STD_B25_ERROR_NO_ENOUGH_MEMORY => {
                write!(f, "ARIB_STD_B25_ERROR_NO_ENOUGH_MEMORY")
            }
            E::ARIB_STD_B25_ERROR_NON_TS_INPUT_STREAM => {
                write!(f, "ARIB_STD_B25_ERROR_NON_TS_INPUT_STREAM")
            }
            E::ARIB_STD_B25_ERROR_NO_PAT_IN_HEAD_16M => {
                write!(f, "ARIB_STD_B25_ERROR_NO_PAT_IN_HEAD_16M")
            }
            E::ARIB_STD_B25_ERROR_NO_PMT_IN_HEAD_32M => {
                write!(f, "ARIB_STD_B25_ERROR_NO_PMT_IN_HEAD_32M")
            }
            E::ARIB_STD_B25_ERROR_NO_ECM_IN_HEAD_32M => {
                write!(f, "ARIB_STD_B25_ERROR_NO_ECM_IN_HEAD_32M")
            }
            E::ARIB_STD_B25_ERROR_EMPTY_B_CAS_CARD => {
                write!(f, "ARIB_STD_B25_ERROR_EMPTY_B_CAS_CARD")
            }
            E::ARIB_STD_B25_ERROR_INVALID_B_CAS_STATUS => {
                write!(f, "ARIB_STD_B25_ERROR_INVALID_B_CAS_STATUS")
            }
            E::ARIB_STD_B25_ERROR_ECM_PROC_FAILURE => {
                write!(f, "ARIB_STD_B25_ERROR_ECM_PROC_FAILURE")
            }
            E::ARIB_STD_B25_ERROR_DECRYPT_FAILURE => {
                write!(f, "ARIB_STD_B25_ERROR_DECRYPT_FAILURE")
            }
            E::ARIB_STD_B25_ERROR_PAT_PARSE_FAILURE => {
                write!(f, "ARIB_STD_B25_ERROR_PAT_PARSE_FAILURE")
            }
            E::ARIB_STD_B25_ERROR_PMT_PARSE_FAILURE => {
                write!(f, "ARIB_STD_B25_ERROR_PMT_PARSE_FAILURE")
            }
            E::ARIB_STD_B25_ERROR_ECM_PARSE_FAILURE => {
                write!(f, "ARIB_STD_B25_ERROR_ECM_PARSE_FAILURE")
            }
            E::ARIB_STD_B25_ERROR_CAT_PARSE_FAILURE => {
                write!(f, "ARIB_STD_B25_ERROR_CAT_PARSE_FAILURE")
            }
            E::ARIB_STD_B25_ERROR_EMM_PARSE_FAILURE => {
                write!(f, "ARIB_STD_B25_ERROR_EMM_PARSE_FAILURE")
            }
            E::ARIB_STD_B25_ERROR_EMM_PROC_FAILURE => {
                write!(f, "ARIB_STD_B25_ERROR_EMM_PROC_FAILURE")
            }

            E::ARIB_STD_B25_WARN_UNPURCHASED_ECM => write!(f, "ARIB_STD_B25_WARN_UNPURCHASED_ECM"),
            E::ARIB_STD_B25_WARN_TS_SECTION_ID_MISSMATCH => {
                write!(f, "ARIB_STD_B25_WARN_TS_SECTION_ID_MISSMATCH")
            }
            E::ARIB_STD_B25_WARN_BROKEN_TS_SECTION => {
                write!(f, "ARIB_STD_B25_WARN_BROKEN_TS_SECTION")
            }
            E::ARIB_STD_B25_WARN_PAT_NOT_COMPLETE => {
                write!(f, "ARIB_STD_B25_WARN_PAT_NOT_COMPLETE")
            }
            E::ARIB_STD_B25_WARN_PMT_NOT_COMPLETE => {
                write!(f, "ARIB_STD_B25_WARN_PMT_NOT_COMPLETE")
            }
            E::ARIB_STD_B25_WARN_ECM_NOT_COMPLETE => {
                write!(f, "ARIB_STD_B25_WARN_ECM_NOT_COMPLETE")
            }
        }
    }
}
